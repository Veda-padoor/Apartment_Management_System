...
function registercomplaint(values, callback) {
    // Assuming the 'complaints' table has columns: id, block_no, room_no, description
    const sql = 'INSERT INTO block (block_no, room_no, complaints) VALUES (?, ?, ?) ON DUPLICATE KEY UPDATE complaints = VALUES(complaints)';
